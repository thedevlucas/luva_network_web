          ...
          <div className="hidden md:flex items-center gap-6 ml-auto">
            ...
            {serverMaintenance ? (
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-black/40 rounded-full border border-white/10">
                ...
                <span className="text-xs font-mono font-bold text-gray-300">{playersOnline.toLocaleString()} Jugadores</span>
              </div>
            )}
            ...
            <div className="px-4 py-3">
              {serverMaintenance ? (
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-black/40 rounded-lg border border-white/10">
                  ...
                  <span className="text-sm font-mono font-bold text-gray-300">{playersOnline.toLocaleString()} Jugadores</span>
                </div>
              )}
            </div>
